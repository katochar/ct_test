...
#define CT_TEST_SUITE_JOIN_I(NAME_) \
    ct_test_suite_Join(&ct_test_suite_global, &(CT_TEST_I_CASE_NMZ(NAME_)))
...
#define CT_TEST_SUITE_JOIN() CT_TEST_SUITE_JOIN_I(CT_TEST_CFG_NONAME)
